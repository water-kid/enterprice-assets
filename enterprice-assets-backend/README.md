...
* 配套前端代码地址[RuoYi-Vue](https://gitee.com/y_project/RuoYi-Vue/tree/master/commendation-ui)，技术栈（[Vue2](https://cn.vuejs.org) + [Element](https://github.com/ElemeFE/element) + [Vue CLI](https://cli.vuejs.org/zh)）。
...
* 阿里云折扣场：[点我进入](http://aly.commendation.vip)，腾讯云秒杀场：[点我进入](http://txy.commendation.vip)&nbsp;&nbsp;
...
演示地址：http://vue.commendation.vip  
文档地址：http://doc.commendation.vip
